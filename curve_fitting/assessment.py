...
class backend:
    ...
    def load_model():
        model = load_model('./models/elevation_model_real_data2018-06-27_19:12:29.h5')
        return(model)
...
class user_evaluation:
    ...
    def batch_test():
        all_raw_training_data = np.load('./data/theM_10m_3.npy')  
        small_step = np.load('./data/theM_1m_3.npy')  
        model = load_model('./models/elevation_model_real_data2018-06-22_19:36:16.h5')
